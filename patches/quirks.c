...
static const struct usb_device_id usb_quirk_list[] = {
	...
	/* Beitong KP40 Xbox 360 mode */
	{ USB_DEVICE(0x20bc, 0x515b), .driver_info = USB_QUIRK_DEVICE_QUALIFIER | USB_QUIRK_NO_LPM },

	/* Beitong KP40 Switch mode */
	{ USB_DEVICE(0x057e, 0x2069), .driver_info = USB_QUIRK_DEVICE_QUALIFIER | USB_QUIRK_NO_LPM },
